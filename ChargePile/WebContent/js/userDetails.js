...
$(function(){
	...
	window.history.forward(-1);
     ...
     switch($access){
     case '管理员':$('#select option:eq(0)').attr('selected','selected');break;
     case '销售人员':$('#select option:eq(1)').attr('selected','selected');break;
     case '普通用户':$('#select option:eq(2)').attr('selected','selected');break;
     }
     $('#select').selectpicker({
    		  style: 'btn-primary',
    		  size: 4
