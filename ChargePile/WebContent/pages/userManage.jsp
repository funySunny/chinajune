...
<script src="js/userManage.js" charset="utf-8"></script>
</head>
<body>
...
<div class="container" style="width:100%;">
			...
			<ul id="main-nav" class="main-nav nav nav-tabs nav-stacked">
                    ...
                    <li>
                        ...
                        <ul id="systemSetting" class="nav nav-list secondmenu collapse in">
                            <li class="active"><a href="javascript:location.reload();"><i class="fa fa-desktop"></i>&nbsp;电脑用户管理</a></li>
                            <li>
	...
	<form id="modifyUserPage" style="display:none;" action="f/toUserDetails/true" target="_blank" method="post">
