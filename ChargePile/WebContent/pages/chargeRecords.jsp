...
<meta name="keywords" content="充电记录管理">
<meta name="description" content="">
<title>充电记录管理</title>
<!-- BootStrap -->
<link href="bootstrap-table/css/bootstrap-table.min.css" rel="stylesheet"/>
<!-- <link href="css/tradeHome.css" rel="stylesheet"/> -->
...
<script src="js/chargeRecords.js" charset="utf-8"></script>
</head>
<body>
                            ...
                            <li><a href="pages/userManage.jsp"><i class="fa fa-desktop"></i>&nbsp;电脑用户管理</a></li>
                             <li>
                	            ...
                	            <ul id="muserManage" class="nav nav-list secondmenu collapse in">
        	                	    ...
        	                	    <li class="active"><a href="javascript:location.reload();"><i class="fa fa-flash"></i>&nbsp;充电记录</a></li>
            	                </ul>
                            </li>
