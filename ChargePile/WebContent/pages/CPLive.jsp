...
<script src="js/CPLive.js"></script>
</head>
<body>
...
<div class="container" style="width:100%;">
                         ...
                         <ul id="CPLiveDataConfig" class="nav nav-list secondmenu collapse in">
                        	<li>
                	            ...
                	            <ul id="ACLive" class="nav nav-list secondmenu collapse in">
	                	            ...
	                	            <li class="active"><a href="javascript:location.reload();"><i class="fa fa-info"></i>&nbsp;实时数据</a></li>
	...
	<div class="col-md-10">
		 <ol class="breadcrumb">
  					...
  					<li><a href="javascript:void(0);">交流充电桩</a></li>
  					<li class="active">充电桩监控</li>
		</ol>
		
	<form id="idForm" style="display:none;" action="f/toCPLiveDetails" target="_blank" method="post">
		<input type="hidden" name="CPid"/>
	</form>
		
	<div class="col-md-12">
		<div class="panel panel-info ac-monitor">
   			<div class="panel-heading">
      			<h3 class="panel-title">实时数据</h3>
   			</div>
   			<div class="panel-body" id="js-PilesMonitor"></div>
		</div>
	</div>
