...
<script src="${pageContext.request.contextPath}/js/CPparameter.js"></script>
			...
			<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
  				 <div class="navbar-header">
   				 ...
   				 <ul id="tabOption" class="nav navbar-nav" >
						<li id="manage"><a href="${pageContext.request.contextPath}/f/UserManage">用户管理</a></li>
         				<li id="CPparameter" class="active"><a href="${pageContext.request.contextPath}/f/CPP">充电桩参数</a></li>
         				<li id="CPstatus"><a href="${pageContext.request.contextPath}/f/CPS">充电桩状态</a></li>
         		 </ul>
   				 </div>
   				 <div>
   				 	<!--向右对齐-->
		...
		<div class="modal fade" id="myLoginModal" tabindex="-1" role="dialog" 
         ...
         <div class="modal-body">
            <form class="form-horizontal" role="form">
            	...
            	<p class="text-center">
            		<label ><a href="${pageContext.request.contextPath}/f/Register">新用户，注册</a></label>
