...
public class Operate {
	...
	private String charger_no;//充电枪编号		
	...
	public String getCharger_no() {
		return charger_no;
	}
	public void setCharger_no(String charger_no) {
	...
	public String toString() {
		return "Operate [id=" + id + ", operate_time=" + operate_time + ", operate_type=" + operate_type
				+ ", charge_method=" + charge_method + ", charger_no=" + charger_no + ", for_energy=" + for_energy
				+ ", for_time=" + for_time + ", order_start_time=" + order_start_time + ", order_end_time="
				+ order_end_time + ", c_p_id=" + c_p_id + ", user_id=" + user_id + ", is_send=" + is_send + "]";
	}
