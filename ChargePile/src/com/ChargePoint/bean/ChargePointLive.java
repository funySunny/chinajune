...
public class ChargePointLive {
	...
	private String v_charge;//充电电压测量值（V）
	private String i_charge;		//充电电流测量值（A）
	...
	public String toString() {
		return "ChargePointLive [id=" + id + ", c_p_id=" + c_p_id + ", time=" + time + ", v_require=" + v_require
				+ ", i_require=" + i_require + ", mode_charge=" + mode_charge + ", v_charge=" + v_charge + ", i_charge="
				+ i_charge + ", v_max=" + v_max + ", soc_now=" + soc_now + ", time_left=" + time_left + ", v_out="
				+ v_out + ", i_out=" + i_out + ", charged_time=" + charged_time + ", charge_allow=" + charge_allow
				+ ", v_max_no=" + v_max_no + ", t_max=" + t_max + ", t_max_no=" + t_max_no + ", t_min=" + t_min
				+ ", t_min_no=" + t_min_no + ", s_v_cell=" + s_v_cell + ", s_soc=" + s_soc + ", o_i_charge="
				+ o_i_charge + ", o_t=" + o_t + ", orins=" + orins + ", s_contact=" + s_contact + ", allow_charge="
				+ allow_charge + "]";
	}
