...
//	#time#,
//	#c_p_id#,#v_require#,#i_require#,#mode_charge#,#v_charge#,
//	#i_charge#,#v_max#,#soc_now#,#time_left#,#v_out#,#i_out#,#v_max_no#,#charged_time#,#charge_allow#,
//	#t_max#,#t_max_no#,#t_min#,#t_min_no#,#s_v_cell#,
//	#s_soc#,#o_i_charge#,#o_t#,#orins#,#s_contact#,
//	#allow_charge#
	@Override
	public String toString() {
		return "ChargePointLive2 [table_name=" + table_name + ", id=" + id + ", c_p_id=" + c_p_id + ", time=" + time
