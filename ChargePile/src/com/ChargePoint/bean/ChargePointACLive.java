...
public class ChargePointACLive {
	...
	public String toString() {
		return "ChargePointACLive [id=" + id + ", c_p_id=" + c_p_id + ", time=" + time + ", v_out=" + v_out + ", i_out="
				+ i_out + ", charged_time=" + charged_time + ", allow_charge=" + allow_charge + "]";
	}
