...
public class ChargeRecords2 {
	...
	/**"charge_records_"+table_name
	 * @param table_name
	 */
	public void setTable_name(String table_name) {
		this.table_name = "charge_records_"+table_name;
	}
	...
	public String toString() {
		return "ChargeRecords2 [table_name=" + table_name + ", id=" + id + ", user_name=" + user_name + ", c_p_id="
				+ c_p_id + ", start_time=" + start_time + ", end_time=" + end_time + ", time_count=" + time_count
				+ ", degree=" + degree + ", total_degree=" + total_degree + ", total_count=" + total_count + ", place="
				+ place + ", money=" + money + ", trade_no=" + trade_no + ", trade_status=" + trade_status + "]";
	}
